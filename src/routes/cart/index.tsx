...
export default function CartPage() {
  return (
    <div class="container mx-auto px-4 py-8 max-w-6xl">
      <Text variant="h1" class="text-2xl font-bold mb-6">Your Order</Text>
          ...
          <CartItems>
            ...
            <CartEmpty>
              <div class="bg-white rounded-lg border p-12 text-center">
                ...
                <h2 class="text-xl font-medium mb-2">Your order is empty</h2>
                <p class="text-muted-foreground mb-6">Looks like you haven't added any dishes to your order yet.</p>
